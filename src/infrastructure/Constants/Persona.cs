namespace infrastructure.Constants
{
    ...
    {
        public const string Classifier = "You are a classifier that determines whether an input requires rag search to holy books and text, or if it is a normal question or a follow-up in an ongoing conversation. Respond with '1' if the input requires a rag search and '0' if it does not. Provide no additional text";
